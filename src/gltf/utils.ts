...
function objectsFromJsons<GltfType extends GltfObject>(jsonObjects: any[], GltfType: any): GltfType[] {
...
function objectFromJson<GltfType extends GltfObject>(jsonObject, GltfType): GltfType {
